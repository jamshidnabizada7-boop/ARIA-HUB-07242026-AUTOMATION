...
async function main() {
  ...
  const catNames = ['Opportunities','Education','Career','Translation','Technology','Marketing','Consulting'];
  ...
  const services = [
    ...
    { title: 'Website & Software Development', slug: 'web-development', cat: 'Technology', icon: 'Laptop', image: '/images/services/finance.png', excerpt: 'Custom websites and web applications.', description: 'Custom business websites, e-commerce platforms, admin dashboards, and reliable web application development.', price: 'From $500', featured: true, titleI18n: {"en":"Website & Software Development","fa":"توسعه وب‌سایت و نرم‌افزار","ps":"د ویب سایټ او سافټویر پراختیا"}, excerptI18n: {"en":"Custom websites and web applications.","fa":"وب‌سایت‌ها و برنامه‌های وب سفارشی.","ps":"دودیز ویب سایټونه او ویب اپلیکیشنونه."}, descriptionI18n: {"en":"Custom business websites, e-commerce platforms, admin dashboards, and reliable web application development.","fa":"وب‌سایت‌های تجاری سفارشی، پلتفرم‌های تجارت الکترونیک، داشبوردهای مدیریتی و توسعه برنامه‌های وب قابل اعتماد.","ps":"دودیز سوداګریز ویب سایټونه، د ای کامرس پلیټ فارمونه، د اډمین ډشبورډونه، او باوري ویب اپلیکیشن پرمختګ."} },
