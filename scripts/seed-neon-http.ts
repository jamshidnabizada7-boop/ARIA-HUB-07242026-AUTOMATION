...
async function run() {
  ...
  const services = [
    ...
    ['Website & Software Development','web-development','Technology','Laptop','/images/services/finance.png','Custom websites and web applications.','Custom business websites, e-commerce platforms, admin dashboards, and reliable web application development.','From $500',true,{"en":"Website & Software Development","fa":"توسعه وب‌سایت و نرم‌افزار","ps":"د ویب سایټ او سافټویر پراختیا"},{"en":"Custom websites and web applications.","fa":"وب‌سایت‌ها و برنامه‌های وب سفارشی.","ps":"دودیز ویب سایټونه او ویب اپلیکیشنونه."},{"en":"Custom business websites, e-commerce platforms, admin dashboards, and reliable web application development.","fa":"وب‌سایت‌های تجاری سفارشی، پلتفرم‌های تجارت الکترونیک، داشبوردهای مدیریتی و توسعه برنامه‌های وب قابل اعتماد.","ps":"دودیز سوداګریز ویب سایټونه، د ای کامرس پلیټ فارمونه، د اډمین ډشبورډونه، او باوري ویب اپلیکیشن پرمختګ."}],
