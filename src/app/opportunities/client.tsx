...
const FormattedContent = ({ content }: { content: string }) => {
  ...
  return (
    <div dir="auto" className="prose prose-sm max-w-none break-words overflow-hidden text-foreground/80 prose-p:leading-relaxed text-start [&_ul]:!ps-6 [&_ul]:!pe-0 [&_ol]:!ps-6 [&_ol]:!pe-0">
